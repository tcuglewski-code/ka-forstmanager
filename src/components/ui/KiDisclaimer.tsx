...
export default function KiDisclaimer({
  ...
  if (variant === "badge") {
    return (
      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-amber-100 border border-amber-200 rounded-md text-xs text-amber-800">
        <span>⚠️</span>
        ...
        <button
          ...
          className="ml-1 p-0.5 rounded hover:bg-amber-100 text-amber-800 hover:text-amber-300 transition-colors flex-shrink-0"
  ...
  return (
    <div className="flex items-center justify-between gap-3 px-4 py-2.5 mb-4 bg-amber-500/10 border border-amber-500/30 rounded-lg">
      ...
      <button
        ...
        className="p-1 rounded hover:bg-amber-100 text-amber-800 hover:text-amber-300 transition-colors flex-shrink-0"
        aria-label="Hinweis schließen"
      >
