      ...
      <div className="bg-[var(--color-surface-container)] border border-border rounded-xl w-full max-w-md">
        <div className="flex items-center justify-between p-4 border-b border-border">
          <div>
            ...
            <p className="text-xs text-[var(--color-on-surface-variant)] mt-0.5">Saison: {saisonName}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          {/* Typ */}
          <div>
            <label className="block text-xs text-[var(--color-on-surface-variant)] mb-1">Auftragstyp *</label>
            <select
              value={form.typ}
