...
export function FristenWidget() {
  ...
  return (
    <div className="bg-[var(--color-surface-container)] border border-amber-900/30 rounded-xl p-4">
      ...
      {programme.length > 3 && (
        <button
          ...
          className="mt-2 flex items-center gap-1 text-xs text-[var(--color-on-surface-variant)] hover:text-zinc-300 transition-colors w-full justify-center"
        >
