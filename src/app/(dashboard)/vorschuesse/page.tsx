          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="text-left px-6 py-3 text-xs text-[var(--color-on-surface-variant)] uppercase tracking-wider">Grund</th>
                <th className="text-left px-6 py-3 text-xs text-[var(--color-on-surface-variant)] uppercase tracking-wider">Genehmigt</th>
                <th className="text-left px-6 py-3 text-xs text-[var(--color-on-surface-variant)] uppercase tracking-wider">Zurückgezahlt</th>
            ...
            <tbody className="divide-y divide-border">
              {vorschuesse.length === 0 ? (
                ...
                <tr key={v.id} className="hover:bg-[#1c1c1c]">
                  ...
                  <td className="px-6 py-4">
                    <button onClick={() => patch(v.id, { zurueckgezahlt: !v.zurueckgezahlt })} className={`w-10 h-5 rounded-full transition-all ${v.zurueckgezahlt ? "bg-emerald-500" : "bg-[var(--color-surface-container-high)]"}`} title="Toggle zurückgezahlt" />
                  </td>
