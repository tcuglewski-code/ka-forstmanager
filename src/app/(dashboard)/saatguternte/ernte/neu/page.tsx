              ...
              <div className="relative">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-2 bg-[var(--color-surface-container-highest)] border border-border rounded-lg text-white placeholder-zinc-500 focus:outline-none focus:border-emerald-600"
                  />
                </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                max="2100"
                required
                className="w-full px-3 py-2 bg-[var(--color-surface-container-highest)] border border-border rounded-lg text-white focus:outline-none focus:border-emerald-600"
              />
            </div>
            <div>
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-[var(--color-surface-container-highest)] border border-border rounded-lg text-white focus:outline-none focus:border-emerald-600 resize-none"
              />
            </div>
          </div>
        </div>
              ...
              {sammler.map((s) => (
                <div key={s.id} className="grid grid-cols-12 gap-2 items-center">
                  <input
                    ...
                    placeholder="Name"
                    className="col-span-3 px-3 py-2 bg-[var(--color-surface-container-highest)] border border-border rounded-lg text-white text-sm focus:outline-none focus:border-emerald-600"
                  />
                  <input
                    type="date"
                    value={s.datum}
                  ...
                  <input
                    ...
                    step="0.1"
                    min="0"
                    className="col-span-2 px-3 py-2 bg-[var(--color-surface-container-highest)] border border-border rounded-lg text-white text-sm focus:outline-none focus:border-emerald-600"
                  />
                  <input
                    type="number"
                    value={s.stunden}
