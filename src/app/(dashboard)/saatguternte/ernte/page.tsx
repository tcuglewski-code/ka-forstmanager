          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#2a2a2a] bg-[#111]">
                ...
                <th className="px-4 py-3 text-right text-zinc-400 font-medium">Menge (kg)</th>
                <th className="px-4 py-3 text-left text-zinc-400 font-medium">Sammler</th>
                <th className="px-4 py-3 text-center text-zinc-400 font-medium">Aktionen</th>
              </tr>
            </thead>
            <tbody>
              {ernten.length === 0 ? (
                        ...
                        {sammlerNamen.length > 0 ? (
                          <div className="flex flex-wrap gap-1">
                            ...
                            {sammlerNamen.length > 2 && (
                              <span className="text-zinc-500 text-xs">+{sammlerNamen.length - 2}</span>
                            )}
                          </div>
                        ) : (
                          <span className="text-zinc-600 text-xs">—</span>
