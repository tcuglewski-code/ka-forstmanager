  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <select
        ...
        className="px-3 py-2 bg-[var(--color-surface-container-highest)] border border-border rounded-lg text-[var(--color-on-surface)] text-sm focus:outline-none focus:border-emerald-600"
      >
      ...
      {hasFilter && (
        <button
          onClick={reset}
          className="px-3 py-2 text-[var(--color-on-surface-variant)] hover:text-[var(--color-on-surface)] text-sm transition-colors"
        >
          × Filter zurücksetzen
        </button>
      )}
