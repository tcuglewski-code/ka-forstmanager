...
function go(n){ _kaSearchA=''; _kaSearchB=''; _kaSearchBP=''; S.step=n; saveDraft(); try{history.pushState({step:n},'','#step-'+n);}catch(e){} render(); kawSyncFooter(); window.scrollTo(0,0); }
...
function render(){
  ...
  var el=document.getElementById('kaw-main');
  if(!el) return;
  switch(S.step){
...
function showOK(){ clearDraft();
  ...
  document.getElementById('kaw-main').innerHTML='<div class="pf-card"><div class="pf-ok">'
